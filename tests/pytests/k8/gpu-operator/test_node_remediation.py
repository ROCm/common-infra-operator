...
def test_anr_workflow(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, condition_type, clean_params, images=images))
...
def test_custom_configmap(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, condition_type, {'remediationWorkflow.enable': False}, images=images))
...
def test_max_parallel_workflows(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    request.addfinalizer(lambda: anr_util.cleanup_workflow(
        deviceconfig_install, environment, CONDITION, clean_params, images=images))
...
def test_skip_reboot_step(gpu_cluster, images, deviceconfig_install, environment, request):
...
def test_pre_condition_workflow(gpu_cluster, images, deviceconfig_install, environment, request):
    global Logger
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, "AMDGPUHwsHang", {'remediationWorkflow.enable': False}, images=images))
...
def test_custom_taint(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, CONDITION, {'remediationWorkflow.enable': False}, images=images))
...
def test_multiple_node_conditions_sequential(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, [CONDITION_1, CONDITION_2], {'remediationWorkflow.enable': False}, images=images))
...
def test_node_label_removal(gpu_cluster, images, deviceconfig_install, environment, request):
    ...
    REMEDIATION_LABEL_KEY = "amd.com/gpu.remediating"
    clean_params = {'remediationWorkflow.enable': False}
    request.addfinalizer(lambda: anr_util.cleanup_workflow(deviceconfig_install, environment, CONDITION, clean_params, images=images))
